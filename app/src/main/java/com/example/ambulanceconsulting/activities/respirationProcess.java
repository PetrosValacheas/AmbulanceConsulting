...
import com.example.ambulanceconsulting.activities.Math.Fft2;
...
public class respirationProcess extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.respiration_process);
    ...
    private Camera.PreviewCallback previewCallback = new Camera.PreviewCallback() {
        ...
        public void onPreviewFrame(byte[] data, Camera cam) {
            ...
            if(Breath != 0 ){
                Intent i=new Intent(respirationProcess.this,respiration_result.class);
